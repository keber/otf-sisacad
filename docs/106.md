## 🧩 Task AB#106 - Create the ProgramaFormativo class

### 🎯 Objective

Implement the `ProgramaFormativo` class as the base entity of the OTEC TuFuturo academic system, applying TDD principles, constructor-level validations, and JPA annotations for persistence. This class represents the training programs offered by the organization.

---

### 🔧 Activities carried out

- Defined the `ProgramaFormativo` class with the fields `id`, `nombre`, `fechaInicio`, `fechaFin`.
