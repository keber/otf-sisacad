## 👤 Task AB#112 - Create the frontend for ProgramaFormativo
...
Build the graphical user interface (React frontend) to perform CRUD operations on the `ProgramaFormativo` entity, connecting to the REST backend already implemented with Spring Boot.
...
#### ✔️ Cycle 1 – Rendering the list (`ProgramaList`)
...
#### ✔️ Cycle 2 – Form and program creation
...
| ---------------------- | ------------------------------------------------------------- |
| `App.js`               | Main component; orchestrates the form and the list           |
| `ProgramaForm.js`      | Form to register and update programs                         |
| `ProgramaList.js`      | Display table and actions (edit, delete)                     |
| `ProgramaForm.test.js` | Form tests: validation and submission                        |
| `ProgramaList.test.js` | List tests: editing and deletion with modal confirmation     |
...
| File                                 | Action                                                                  |
| ------------------------------------ | ---------------------------------------------------------------------- |
| `ProgramaNoEncontradoException.java` | Added a test to validate the message produced from the `id`           |
...
| `ProgramaFormativoDTO.java`          | Added basic getter/setter and instance-creation tests                 |
